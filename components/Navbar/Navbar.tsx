...
const Navbar = () => {
  ...
  return (
    <nav className='bg-primary dark:bg-sidebar text-primary-foreground dark:text-foreground shadow-md transition-colors duration-300'>
      {/* Logo */}
      <div className='container mx-auto max-w-[1360px] relative min-h-[50px] px-2 py-1 flex flex-col md:flex-row md:justify-between md:items-center'>
        ...
        <div className='flex flex-row gap-12 items-center font-kanit'>
          {/* Menu Items */}
          <ul className='flex flex-col gap-4 md:flex md:flex-row my-2 items-center'>
